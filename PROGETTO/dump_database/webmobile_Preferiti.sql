...
CREATE TABLE `Preferiti` (
  ...
  CONSTRAINT `Preferiti_ibfk_1` FOREIGN KEY (`refUtente`) REFERENCES `Utenti` (`idUtente`),
  CONSTRAINT `Preferiti_ibfk_2` FOREIGN KEY (`refLibroCartaceo`) REFERENCES `LibriCartacei` (`idLibroCartaceo`)
